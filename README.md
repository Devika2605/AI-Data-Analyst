...
|---|---|---|
| `LLM_PROVIDER` | `groq` | `anthropic`, `openai`, `groq`, or `none` (offline mode) |
| `LLM_API_KEY` | *env* | API key for the chosen provider  |
| `LLM_MODEL` | `llama-3.3-70b-versatile` | Model name for the provider |
| `LLM_BASE_URL` | ** | Optional API base URL override; auto-filled for Groq, only needed for other OpenAI-compatible providers |
...
[ demo video link .](https://drive.google.com/file/d/1g0ylp87AEUJL03tUB9bIu7znmpA36ovy/view?usp=drive_link)
